          ...
          <div class="p-3 py-5">
            ...
            <div class="row mt-2">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control user-form-control" placeholder="First name" value="" data-field="first_name" disabled/>
              </div>
              <div class="col-md-6">
                <label class="labels user-labels">Last Name</label>
                <input type="text" class="form-control user-form-control" value="" placeholder="Last name" data-field="last_name" disabled />
              </div>
            </div>
            <div class="row mt-3">
              <div class="col-md-12">
                <label class="labels user-labels">Mobile Number</label>
                <input type="text" class="form-control user-form-control" placeholder="Phone number" value="" data-field="phone_number"  disabled/>
              </div>
              <div class="col-md-12">
                <label class="labels user-labels">Email ID</label>
                <input type="text" class="form-control user-form-control" placeholder="example@email.com" value="" data-field="email" disabled />
              </div>
              <div class="row mt-4">
                <div class="col-md-4">
                  <label class="labels user-labels">Roll</label>
                  <select class="form-select user-form-select" aria-label="Default select" data-field="roll"  disabled>
                  </select>
                </div>
                <div class="col-md-4">
                  <label class="labels user-labels">Username</label>
                  <input type="text" class="form-control user-form-control" placeholder="@username" value="" data-field="username"  disabled/>
                </div>
                <div class="col-md-4">
                  <label class="labels user-labels">Password</label>
                  <input type="password" class="form-control user-form-control" placeholder="password" value="" data-field="password"  disabled/>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-4 h-100 border-start">
          <div class="p-3 py-5 h-100">
            <div class="d-flex justify-content-between align-items-center experience">
              <span>Other users in this system</span>
            </div>
            <br />
